            ...
            <div className='flex flex-col h-full space-y-5 justify-between min-h-screen w-60 px-2 py-4 bg-white'>
                <div className="flex flex-col justify-start items-center">
                    ...
                    <div className='w-full border-b border-grey-100'>
                        <NavLink to={'/stats'} className={'flex mb-2 justify-start items-center gap-4 pl-5 hover:bg-primary-500 p-2 group cursor-pointer hover:shadow-lg m-auto ' + (lastPathVar.pathname === '/stats' ? 'bg-primary-500' : '')}>
                        ...
                        <NavLink to={'/course'} className={'flex mb-2 justify-start items-center gap-4 pl-5 hover:bg-primary-500 p-2 group cursor-pointer hover:shadow-lg m-auto ' + (lastPathVar.pathname === '/course' ? 'bg-primary-500' : '')}>
                        ...
                        <NavLink to={'/career'} className={'flex mb-2 justify-start items-center gap-4 pl-5 hover:bg-primary-500 p-2 group cursor-pointer hover:shadow-lg m-auto ' + (lastPathVar.pathname === '/career' ? 'bg-primary-500' : '')}>
