...
public class CourseELearningApplication implements CommandLineRunner {
	...
	public void readFile() throws IOException {
		...
		CourseELearningApplication instance = new CourseELearningApplication();
		for (Skill skillEnum : Skill.values()){
			String skill = skillEnum.name();
			InputStream is = instance.getFileAsIOStream("data/udemy_"+skill.toLowerCase()+".csv");
			instance.csvToCourses(is, skill);
		}
	}
