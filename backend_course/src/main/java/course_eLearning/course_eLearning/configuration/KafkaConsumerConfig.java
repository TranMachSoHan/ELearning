...
public class KafkaConsumerConfig {
    @Bean
    public ConsumerFactory<String, CommentDTO> consumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, CommentDTO> kafkaListenerContainerFactory() {
